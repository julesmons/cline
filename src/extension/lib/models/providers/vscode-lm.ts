...
import type { ReclineMessage } from "@extension/core/tasks";
import type { Model, ModelProviderConfig, ProviderResponseStream } from "@extension/core/models";
...
import { isClaudeSonnet } from "@common/utils/models/claude";
import { extractMessageFromThrow } from "@common/utils/exception";

import { StatefulModelProvider } from "@extension/core/models";

import { roughlyEstimateTokenCount } from "@extension/lib/models/utils/tokenCount";


export const ERROR_PREFIX = "Recline <Language Model API>";
...
export class VSCodeLmModelProvider extends StatefulModelProvider<VSCodeLmModelProviderConfig> {
   ...
   * @param messages - Array of ReclineMessage objects containing message content
