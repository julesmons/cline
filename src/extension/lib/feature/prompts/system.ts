...
import type { McpHub } from "@extension/integrations/mcp/McpHub";

import type { ReclineSettings } from "../settings/types";
...
${model.supportsComputerUse
    ...
    *   **Browser Resolution:** \`${settings.browser.viewport.width}x${settings.browser.viewport.height}\` pixels. Ensure click coordinates are within this range.
