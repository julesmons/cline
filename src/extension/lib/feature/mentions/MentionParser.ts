...
import { InvalidMentionError, type Mention, mentionRegexGlobal, MentionType } from "@extension/core/mentions";

import { ReclineWorkspace } from "../../../integrations/workspace/ReclineWorkspace";
...
export class MentionParser {
  ...
  private static createMention(value: string, raw: string): Mention {
    ...
    if (value.startsWith("/")) {
      ...
      const mentionStat = statSync(resolve(ReclineWorkspace.workspaceRoot, mentionPath)); // @TODO: Replace with vscode fs??
      return {
